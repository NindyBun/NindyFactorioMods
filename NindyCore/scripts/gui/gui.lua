...
function nindycore.core.gui.add_close_button(guiTable)
    local button = nindycore.core.gui.add_button(guiTable, guiTable.gui.name .. "_CloseButton", guiTable.vars.topBarFlow, "utility.close_white", "utility.close_black", "utility.close_black", {"gui-description."..nindycore.core.add_mod_tag("CloseButton")}, 20)
